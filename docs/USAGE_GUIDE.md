...
- [3. 镜头运镜参数详解与两种调整方法 (核心)](#3-镜头运镜参数详解与两种调整方法-核心)
  - [3.1 镜头参数 (Camera) 物理意义与坐标系](#31-镜头参数-camera-物理意义与坐标系)
  - [3.2 调整方法 A：HUD 可视化实时调镜 (推荐 · 所见即所得)](#32-调整方法-a-hud-可视化实时调镜-推荐--所见即所得)
  - [3.3 调整方法 B：直接修改 JSON 配置文件 (精准数值控制)](#33-调整方法-b-直接修改-json-配置文件-精准数值控制)
  - [3.4 镜头取景最佳实践与经验参考值](#34-镜头取景最佳实践与经验参考值)
- [4. 高亮选框与流光连线标定指南](#4-高亮选框与流光连线标定指南)
  - [4.1 鼠标拖拽拉框 (Drag-to-Box)](#41-鼠标拖拽拉框-drag-to-box)
  - [4.2 Alt+单击智能边缘吸附 (Pixel Snap)](#42-alt单击智能边缘吸附-pixel-snap)
  - [4.3 8 向吸附锚点与流光连线配置](#43-8-向吸附锚点与流光连线配置)
- [5. 快捷键一览与常见问题 (FAQ)](#5-快捷键一览与常见问题-faq)
...
## 3. 镜头运镜参数详解与两种调整方法 (核心)

### 3.1 镜头参数 (Camera) 物理意义与坐标系
...
1. **唤起标定工具**：在浏览器页面中按下快捷键 **`Ctrl + Shift + D`**（Mac 上为 `Cmd + Shift + D`）；
