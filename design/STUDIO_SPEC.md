...
```
 ...
 └────────────────────────────────────────────────────────────────────────┘
                                    ...
                                    ▼
 ┌────────────────────────────────────────────────────────────────────────┐
 │ 🌌 视觉引擎进阶：视差深度与滚轮交互叙事储备 (Parallax & Scrollytelling)│
 ├────────────────────────────────────────────────────────────────────────┤
 │  • 规划 1: 运镜过渡多图层深度差异与悬浮立体感 (2.5D Depth Parallax)     │
 │  • 规划 2: 受众端滚轮交付叙事与无级擦除 (Scroll-driven Scrollytelling) │
 │  • 独立规范详见：design/PARALLAX_AND_SCROLLYTELLING_SPEC.md            │
 └────────────────────────────────────────────────────────────────────────┘
```
